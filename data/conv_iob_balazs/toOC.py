...
def convert_to_oc(from_format, prec, curr, succ):
    global inside
...
if __name__ == '__main__':
    ...
    for l in fh:
        ...
        if len(l) > 0:
            ...
            suc_label = ''
        if len(cur) > 0:
            print(''.join(cur), convert_to_oc(iob_format, prec_label, cur_label, suc_label))
        else:
            print()
